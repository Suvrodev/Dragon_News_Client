...
const Navbar = () => {
  ...
  const {user,Logout_}=useContext(AuthContext)
    ...
    <li><NavLink className={({isActive})=> isActive? 'text-blue-500 font-extrabold':''}  to='/career'>Career</NavLink ></li>
</div>
        ...
        <div className="navbar-start ">
          ...
          <div className="dropdown">
           ...
           {/* Logo and Website Name Start */}
            <h1 className='text-xl md:text-4xl webName '>Dragon News</h1>
